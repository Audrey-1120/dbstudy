...
UPDATE ORDER_T SET ORDER_ID = TO_CHAR(ORDERED_AT, 'YYMMDD') || '-' || ORDER_SEQ.NEXTVAL;

SELECT TO_CHAR(ORDERED_AT, 'YYMMDD')
  FROM ORDER_T;
...
ALTER TABLE ORDER_T 
    ADD CONSTRAINT FK_CUSTOMER_ORDER FOREIGN KEY(CUST_ID)
        REFERENCES CUSTOMER_T(CUST_ID)
                ON DELETE SET NULL;
                
ALTER TABLE ORDER_T
    ADD CONSTRAINT FK_BOOK_ORDER FOREIGN KEY(BOOK_ID)
        REFERENCES BOOK_T(BOOK_ID)
                ON DELETE SET NULL;
