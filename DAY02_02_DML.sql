...
CREATE TABLE EMPLOYEE_T (
    ...
    CONSTRAINT FD_EMPLOYEE_DEPARTMENT FOREIGN KEY(DEPART) REFERENCES DEPARTMENT_T(DEPT_NO) ON DELETE SET NULL
);
...
-- 1. DEPARTMENT에서 부서번호(DEPT_NO)가 3인 부서의 지역(LOCATION)을 '인천'으로 수정하시오.
UPDATE DEPARTMENT_T
